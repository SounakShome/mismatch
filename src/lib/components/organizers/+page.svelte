...
<div class="min-h-screen flex items-center justify-center p-4 site-background">
    ...
    {#each items as sponsor, i (sponsor.id)}
      ...
      >
        <div class="relative group w-40 md:w-56 hover:scale-105 transition-transform duration-300">
          ...
          <div 
            class="relative bg-[#1a1a3d] rounded-2xl p-4 md:p-6 flex flex-col items-center space-y-3 md:space-y-5 shadow-2xl border border-[#2a2a5f] sponsor-box"
            style="background-image: url({sponsor.bgImage}); background-size: cover; background-position: center;"
          >
            ...
            <div class="text-center backdrop-blur-sm bg-black/40 p-2 rounded-lg">
