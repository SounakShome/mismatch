<script lang=ts>
	...
	function onScanSuccess(decodedText: string) {
		try {
			participantDetails = JSON.parse(decodedText);
			showModal = true;
			scanning = false;
			scanCount++;
		} catch (error) {
...
<div class="container" in:fade={{ duration: 300 }}>
	<div class="scanner-container" in:fly={{ y: 20, duration: 800, easing: elasticOut }}>
	...
	{#if showModal}
		<div class="modal-overlay" transition:fade={{ duration: 200 }}>
			<div class="modal" transition:scale={{ duration: 400, easing: elasticOut }}>
					...
					{#if participantDetails}
						<div class="details">
							{#each Object.entries(participantDetails) as [key, value]}
								<div class="detail-item" in:fly={{ y: 20, duration: 300, delay: 200 }}>
